...
goods_and_services_annual_totalpop_df 		 			= min_grossincome_annual.df  * population.df					# the total value of providing everyone in the population with a minimum-wage worth of goods and services
